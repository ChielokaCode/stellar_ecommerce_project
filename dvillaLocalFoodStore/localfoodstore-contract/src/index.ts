...
export type DataKey = {tag: "Order", values: readonly [u64]} | {tag: "Recipient", values: void} | {tag: "User", values: readonly [string]} | {tag: "Token", values: void} | {tag: "RecipientClaimed", values: void} | {tag: "TargetAmount", values: void} | {tag: "OrderCounter", values: void} | {tag: "UserOrderTracker", values: readonly [string]} | {tag: "Balance", values: readonly [string]} | {tag: "UserRewards", values: readonly [string]} | {tag: "UserTransactionId", values: readonly [string]} | {tag: "UserRegId", values: readonly [string]} | {tag: "UserCounter", values: void};
...
export class Contract {
    ...
    token = async <R extends ResponseTypes = undefined>(options: {
        /**
    ...
    recipient = async <R extends ResponseTypes = undefined>(options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    transferXlm = async <R extends ResponseTypes = undefined>({from, to, amount}: {from: string, to: string, amount: i128}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    register = async <R extends ResponseTypes = undefined>({user_address, name, email}: {user_address: string, name: string, email: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    login = async <R extends ResponseTypes = undefined>({user_address}: {user_address: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    getUserName = async <R extends ResponseTypes = undefined>({user_address}: {user_address: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    initialize = async <R extends ResponseTypes = undefined>({recipient, target_amount, token}: {recipient: string, target_amount: i128, token: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    placeOrder = async <R extends ResponseTypes = undefined>({user, amount}: {user: string, amount: i128}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    getOrder = async <R extends ResponseTypes = undefined>({order_id}: {order_id: u64}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    getTotalUserRewards = async <R extends ResponseTypes = undefined>({user}: {user: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    processUserReward = async <R extends ResponseTypes = undefined>({user}: {user: string}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
    ...
    getOrdersByUser = async <R extends ResponseTypes = undefined>({user, start, limit}: {user: string, start: u64, limit: u64}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number
